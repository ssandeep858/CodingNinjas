 ...
 *         of a = 1, b = 2, c = 3, ... , z = 26. You are given a numeric string
 *         S. Write
 *         a program to return the list of all possible codes that can be
 *         generated from
 *         the given string. Note : The order of codes are not important. And
 *         input
 *         string does not contain 0s. Input format : A numeric string
 *         Constraints : 1
 *         <= Length of String S <= 10 Sample Input: 1123 Sample Output: aabc
 *         kbc alc
 *         aaw kw
 *         1️⃣ What “2 choices” REALLY means
 * 
 *         “2 choices” does NOT mean:
 * 
 *         “each digit can be decoded in 2 ways”
 * 
 *         It means:
 * 
 *         At a given position, you may choose
 *         how many digits to consume (1 or 2)
 * 
 *         That’s it. This is why 2^n is dangerous
 */
    ...
    public static String[] getCode(String input) {
        ...
        if (check1) {
            ...
            for (int i = 0; i < smallOutput2.length; i++) {
                ...
                finalOutput[i + smallOutput1.length] = helper(Integer.parseInt(input.substring(0, 2))) + ""
                        + smallOutput2[i];
            }
            return finalOutput;
        } else {
            ...
            for (int i = 0; i < smallOutput1.length; i++) {
                ...
                smallOutput1[i] = helper(Integer.parseInt(input.charAt(0)+"")) + "" + smallOutput1[i];
            }
            return smallOutput1;
        }
