 ...
 *         using the
 *         following rules: a. The string begins with an 'a' b. Each 'a' is
 *         followed by
 *         nothing or an a or bb c. Each bb is followed by nothing or an 'a' If
 *         all the
 *         rules are followed by the given string, return true otherwise return
 *         false.
 */
