 ...
 * number it represents. That is input will be a numeric string that contains
 * only numbers, you need to convert the string into corresponding integer and
 * return the answer. Input format : Numeric string S (string, Eg. "1234")
 * Output format : Corresponding integer N (int, Eg. 1234) Constraints : 0 < |S|
 * <= 9 where |S| represents length of string S. Sample Input 1 : 00001231
