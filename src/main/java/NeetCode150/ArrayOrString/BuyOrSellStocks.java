...
/**
 *
 * @author ssingh You are given an array prices where prices[i] is the price of
 ...
 *         (price = 1)
 *         and sell on day 5 (price = 6), profit = 6-1 = 5. Note that buying on
 *         day 2
 *         and selling on day 1 is not allowed because you must buy before you
 *         sell.
 *         Example 2:
 *
...
public class BuyOrSellStocks {
    ...
    public static int maxProfit(int[] prices) {
        ...
        for (int i = 1; i < prices.length; i++) {
            // if else because the day you can buy you cannot sell the stock.
    ...
    public static void main(String[] args) {
        System.out.println(maxProfit(new int[] { 7, 2, 5, 1, 6 }));
    }
