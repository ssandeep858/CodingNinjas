 ...
 *         ["mobile","moneypot","monitor","mouse","mousepad"]. After typing m
 *         and mo all
...
public class SuggestedProducts {
    ...
    // either red or black.
    // It is a type of self balancing binary search tree. It has a good efficient
    ...
    public static List<List<String>> suggestedProducts(String[] products, String searchWord) {
        ...
        for (Character c : searchWord.toCharArray()) {
            key += c;
            // Ceiling returns the least key (or entry)
            // that is greater than or equal to the specified key.
            // Floor returns the greatest key (or entry) that is less or equal to the
            // specified key.
        ...
        // Once matches stop, remaining prefixes should return empty suggestions.
    ...
    public static void main(String[] args) {
        List<List<String>> res = suggestedProducts(
