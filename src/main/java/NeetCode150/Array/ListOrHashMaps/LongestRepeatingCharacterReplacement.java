 ...
 *         string and change it to any other uppercase English character. You
 *         can
 ...
 *         'A' in the
 *         middle with 'B' and form "AABBBBA". The substring "BBBB" has the
 *         longest
 *         repeating letters, which is 4. There may exists other ways to achieve
 *         this
 *         answer too.
 */
